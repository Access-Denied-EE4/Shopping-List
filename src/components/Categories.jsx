          ...
          <div>
            ...
            <Container>
                ...
                sx={{
                    ...
                    <Card data-testid="meatcard" onClick={()=>navigate('/meat')} key={'meat'}>
                    ...
                    <Card data-testid="dairycard" onClick={()=>navigate('/dairy')}  key={'dairy'}>
                    ...
                    <Card data-testid="drinkcard" onClick={()=>navigate('/drink')}  key={'drink'}>
                    ...
                    <Card  data-testid="readycard" onClick={()=>navigate('/ready')} key={'ready'}>
                    ...
                    <Card data-testid="vegcard"  onClick={()=>navigate('/veg')} key={'veg'}>
                    ...
                    <Card  data-testid="sweetcard"  onClick={()=>navigate('/sweet')} key={'sweet'}>
                    ...
                    <Card data-testid="toiletriescard"  onClick={()=>navigate('/toilet')} key={'category7'}>
